...
Public routes follow `api/openapi.yaml`: `/v1/now`, `/v1/date`, `/v1/batch`, `/v1/range`, `/v1/year/{year}`, `/v1/calculation-day`, `/v1/locales`, `/v1/meta`, `/v1/status`, `/openapi.json`, and `/openapi.yaml`.
