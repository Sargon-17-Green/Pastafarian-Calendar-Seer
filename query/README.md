...
The layer owns request/default semantics, exact integer handling, Gregorian/JDN conversion, observer relevance, canonical index conversion, English presentation, batch/range semantics, reverse conversion with full tuple cross-checking, and stable query errors.
