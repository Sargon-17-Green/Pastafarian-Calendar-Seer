...
export function createPrecomputedProvider({
  ...
  const exact = createExactEngine({ generatedDir, yearBatchBinary, yearLocatorBinary, yearStructureBinary, dataDir, timeoutMs: exactTimeoutMs, maxBuffer: exactMaxBuffer });
