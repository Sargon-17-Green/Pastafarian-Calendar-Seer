...
int main(int argc,char**argv){
 if(argc<4){std::cerr<<"usage: canonical_vector_oracle POS_GATES calc target [--negative-gates=PATH] [--raw-mutant]\n";return 2;}
 bool saved=true;std::string neg;
 ...
 auto r=calculate(calc,target,G,saved);
