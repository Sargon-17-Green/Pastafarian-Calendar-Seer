...
"$CXX" "${COMMON[@]}" "${BACKEND_FLAGS[@]}" "$ROOT/src/seer_year_structure.cpp" -lgmpxx -lgmp -o "$ROOT/build/seer_year_structure"
echo "Built $ROOT/build/seer_year_structure (RNS backend: $BACKEND; march: $MARCH)"
