...
with (RESULTS/'mulsmall-ab.csv').open('w',newline='') as f:
...
for case,_,_ in cases:
    ...
    a=meds['base']; b=meds['cand']; out.append(f"cand_vs_base: all_delta_pct={(b['all_ms']/a['all_ms']-1)*100:.2f} rns_delta_pct={(b['rns_count_ms']/a['rns_count_ms']-1)*100:.2f} replay_delta_pct={(b['replay_ms']/a['replay_ms']-1)*100:.2f}"); out.append('')
summary='\n'.join(out); (RESULTS/'mulsmall-summary.txt').write_text(summary+'\n'); print('\n'+summary)
